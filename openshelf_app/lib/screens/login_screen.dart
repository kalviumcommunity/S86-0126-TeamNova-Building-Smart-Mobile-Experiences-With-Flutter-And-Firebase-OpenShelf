              ...
              child: FadeTransition(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Login to continue to OpenShelf',
                      style: TextStyle(
                        fontSize: 16,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            ...
                            icon: const Icon(Icons.widgets, size: 22),
                            label: const Text(
                          ...
                          const SizedBox(height: 12),
                          // Hot Reload & DevTools Demo Button
                          ElevatedButton.icon(
                            onPressed: () {
                              Navigator.pushNamed(context, '/hot-reload-devtools-demo');
                            },
